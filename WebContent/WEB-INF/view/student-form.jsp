...
First name: <form:input path="firstName" /> <!-- andrà al getter -->
...
<form:select path="country"> <!-- submit chiamerà setCountry() -->
...
<!--  
	...
	<form:options items="${student.countryOptions}"/> <!-- chiamerà getCountryOptions -->
